...
async function mainLoop(startState) {
    ...
    var MjpegStream = client.getEntry(client.getKeyID("/CameraPublisher/USB Camera 0/streams")).val[1].substring(5);
    var decoder;
    ...
    while (true) { //Loops through this block
        try {
            ...
            data = await decoder.takeSnapshot();
